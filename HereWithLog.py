...
#fpath = "C:/Skyhook/HERE/Uk/separate/Book8.xlsx"
...
labelText=StringVar()
labelText.set("Name:")
labelDir=Label(root, textvariable=labelText, height=2)
labelDir.grid(row=1,column=1)
labelText2=StringVar()
labelText2.set("Charge Code:")
labelDir2=Label(root, textvariable=labelText2, height=2)
...
buttonCommit=Button(root, height=2, width=10, text="Commit",
...
def write_log(text, file):
    ...
    f.write("{}\n".format(text))
    return
logfile = r"C:\Skyhook\Bookkeping\log.txt"
...
rows=len(carRouting_output.index)
...
write_log('\n'+'The user '+inputValue+' used charge code '+inputValue2+' to request the following amount of rows '+str(rows), logfile)  # Write the specified text to the logfile